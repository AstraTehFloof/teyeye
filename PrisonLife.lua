...
Cmd[#Cmd + 1] =	{Text = "anticrim",Title = "Prevent becoming a criminal"}
	...
	if anticrim then
		game:GetService("RunService").Heartbeat:Connect(function()
			...
			if team == "Criminal" then
				local remote = game.Remote.TeamEvent
				remote:FireServer("Bright Orange")
				wait(1)
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = Vector3.new(917, 100, 2390)
				remote:FireServer("Bright Orange")
			end
		end)
		else
